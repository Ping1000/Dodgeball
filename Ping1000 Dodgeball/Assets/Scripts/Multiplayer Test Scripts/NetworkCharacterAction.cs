...
/*public enum ActionType
{
    Move,
    Throw
}*/ //TODO uncomment if removed from other Character action

public class NetworkCharacterAction
{
    ...
    public NetworkCharacterAction(ActionType type, SmoothMovement mover, Vector3 destPoint)
    {
        _type = type;
        _mover = mover;
